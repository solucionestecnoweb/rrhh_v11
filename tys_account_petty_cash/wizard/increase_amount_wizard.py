...
class ChangeAmountPettyCashWizard(models.TransientModel):
    ...
    increase_amount_petty_cash = fields.Monetary('Monto Incrementado')
    ...
    amount_new = fields.Monetary('Monto Nuevo')
    ...
    def validate_petty_cash(self,petc_ids):
        ...
        if invoice_petty_cash:
            for a in invoice_petty_cash:
                a.write({'apertura': petty_cash.petty_cash_amount_open + self.increase_amount_petty_cash,
                          'disponible': a.disponible + self.increase_amount_petty_cash,
                          })
        ...
        if move_line_id1 and move_line_id2:
            petty_cash.write({'petty_cash_status': 'validate',
                   ...
                   'disponible': petty_cash.disponible + self.increase_amount_petty_cash,
                   'name': petty_cash.name})
