...
{   'active': False,
    ...
    'data': [   'view/account_check_duo_view.xml',
                ...
                'Wizard/wizard_third/view/view_check_deposit.xml',
                'Wizard/wizard_third/view/view_check_hreject.xml',
                'Wizard/wizard_third/view/view_check_dreject.xml',
                'Wizard/wizard_third/view/view_check_sold.xml',
                'Wizard/wizard_third/view/view_ticket_check_deposit.xml',
                'Wizard/_wizard_issued_/view_issued_check_hreject.xml',
