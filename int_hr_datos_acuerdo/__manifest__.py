...
{
    'name': 'Datos de acuerdo',
    'version': '1.0',
    'category': 'Recursos Humanos',
    'summary': 'Permite registrar los datos de acuerdo para los empleados',
    'description': """
Datos de acuerdo
==================================

Permite registrar los datos de acuerdo para los empleados
    Elaborated by Maria Carreño.
    """,

    'author': 'TYSAMNCA',
    'website': 'https://tysamnca.com',
    'depends': ['hr_payroll','hr','base'],
    'data': ['views/int_hr_datos_acuerdo.xml'],
    #'demo': [],
    #'test': [],
    'installable': True
