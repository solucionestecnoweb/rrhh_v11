...
class hr_contract(models.Model):
  ...
  #              monto = str(i.wage)
   ...
   #             i.wage_Letter = False
    ...
    salario_ausencias_ded_mes_ant = fields.Many2one('salary.increase.line', 'Salario mes anterior')
   ...
   # wage_Letter = fields.Char(string='Salario en letra', compute='_conver_mont', store='True')
    ...
    @api.onchange('salario_hours_not_worked_mes_ant','salario_ausencias_ded_mes_ant','salario_bono_nocturno_mes_ant','salario_domingos_laborados_mes_ant','salario_feriado_laborado_mes_ant','reintegro_dias_mes_ant')
    def salario_a_utitlizar(self):
        ...
        elif self.salario_domingos_laborados_mes_ant:
            self.last_month_wage = self.salario_domingos_laborados_mes_ant.past_amount
        elif self.salario_feriado_laborado_mes_ant:
            self.last_month_wage = self.salario_feriado_laborado_mes_ant.past_amount
        elif self.reintegro_dias_mes_ant:
            self.last_month_wage = self.reintegro_dias_mes_ant.past_amount
        elif self.salario_hours_not_worked_mes_ant:
            self.last_month_wage = self.salario_hours_not_worked_mes_ant.past_amount
        elif self.salario_ausencias_ded_mes_ant:
            self.last_month_wage = self.salario_ausencias_ded_mes_ant.past_amount
        else:
            self.last_month_wage = self.wage
...
class hr_payslip(models.Model):
    ...
    def hr_verify_sheet(self):
        ...
        new_values ={
            ...
            'hours_not_worked_mes_ant_value':0,
        ...
        new_values.update({i: False for i in ['prestamo_check', 'cuota_check', 'desc_ind_salary_check', 'ajust_util_check', \
                             ...
                             'reposo_pre_post_check', 'ausencias_ded_mes_ant_check','bono_nocturno_mes_ant_check', 'days_of_salary_pending_mes_anterior_check', 'feriado_laborado_mes_ant_check', 'hours_not_worked_mes_ant_check']})
        ...
        new_values.update({i: 0.0 for i in
                           ['bono_nocturno_float_value','hrs_no_lab_float_value','inasistencia_injustificada_float_value',
                            'permiso_no_remunerado_dias_float_value','permiso_no_remunerado_hrs_float_value', 'hours_not_worked_mes_ant']})
