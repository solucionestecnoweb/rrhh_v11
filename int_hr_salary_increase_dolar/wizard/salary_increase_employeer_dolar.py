        ...
        for wizard in self:
            ...
            [increase.append(
                            (0, 0, {
                                ...
                                'amount': (employee.contract_id.factor_banda * salary_increase.wage)/100  if salary_increase.type_aumento == 'por' and salary_increase.wage else salary_increase.monto,
